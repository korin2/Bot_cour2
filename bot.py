...
async def show_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "• <code>/rates</code> - показывает курсы популярных валют относительно вашей базовой валюты\n"
        "• <code>/rate EUR USD</code> - показывает конкретный курс между двумя валютами\n"
        "• Кнопки в главном меню для быстрого доступа к популярным валютам\n\n"
        
        "🔄 <b>Конвертация валют:</b>\n"
        "• <code>/convert 100 USD EUR</code> - конвертирует сумму из одной валюты в другую\n\n"
        
        "⚙️ <b>Настройки:</b>\n"
        "• <code>/setbase EUR</code> - устанавливает базовую валюту (по умолчанию USD)\n"
        "• Все курсы будут показываться относительно вашей базовой валюты\n\n"
        
        "🔔 <b>Уведомления:</b>\n"
        "• <code>/alert USD RUB 80 above</code> - уведомит, когда курс превысит 80\n"
        "• <code>/alert EUR USD 0.95 below</code> - уведомит, когда курс упадет ниже 0.95\n"
        "• Направления: 'above' (выше) или 'below' (ниже)\n\n"
        
        "🛠 <b>ДОПОЛНИТЕЛЬНЫЕ КОМАНДЫ</b>\n\n"
        "• <code>/start</code> - главное меню с кнопками\n"
        "• <code>/help</code> - это сообщение справки\n"
        "• <code>/stop</code> - остановить бота\n\n"
        
        "💡 <b>ПРИМЕРЫ ИСПОЛЬЗОВАНИЯ</b>\n\n"
        "<code>/rates</code> - посмотреть все курсы\n"
        "<code>/rate GBP JPY</code> - курс фунта к йене\n"
        "<code>/convert 500 EUR USD</code> - перевести 500 евро в доллары\n"
        "<code>/setbase RUB</code> - сделать рубль базовой валютой\n"
        "<code>/alert USD EUR 0.95 above</code> - уведомить о росте доллара выше 0.95 евро\n\n"
        
        "🌍 <b>ПОДДЕРЖИВАЕМЫЕ ВАЛЮТЫ</b>\n\n"
        "• Основные: USD, EUR, GBP, JPY, CNY, RUB, CHF, CAD, AUD\n"
        "• И многие другие мировые валюты\n\n"
        
        "📊 <b>ИСТОЧНИК ДАННЫХ</b>\n\n"
        "Курсы обновляются ежедневно с использованием Frankfurter API - надежного источника финансовых данных.\n\n"
        
        "❓ <b>ПОМОЩЬ И ПОДДЕРЖКА</b>\n\n"
        "Если у вас возникли проблемы или вопросы, используйте команду /help для повторного просмотра этой справки."
    )
